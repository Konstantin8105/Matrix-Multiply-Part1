...
func BenchmarkFinalSimple(b *testing.B) {
...
func BenchmarkFinalParallelBufferVarOut64(b *testing.B) {
	// Stop the timer for avoid add time of generate matrix
	b.StopTimer()
	A, B, C := generateMatrix()
	// Now, we are ready for start timer our benchmark
...
func BenchmarkFinalParallelBufferVarOutSingleSlise4(b *testing.B) {
	// Stop the timer for avoid add time of generate matrix
	b.StopTimer()
